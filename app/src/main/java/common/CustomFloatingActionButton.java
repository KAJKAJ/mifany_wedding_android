...
/**
 * Created by realjangsun on 15. 3. 17..
 */
public class CustomFloatingActionButton extends View {
    ...
    static public class Builder {
        ...
        public CustomFloatingActionButton create() {
            final CustomFloatingActionButton button = new CustomFloatingActionButton(activity);
